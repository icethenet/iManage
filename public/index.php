...
<body>
    ...
    <!-- Image Modal -->
                        ...
                        <div class="security-overview">
                            <div class="security-stat">
                                ...
                                <div class="security-content">
                                    <span class="security-value" id="securityScore">85/100</span>
                            ...
                            <div class="security-stat">
                                ...
                                <div class="security-content">
                                    <span class="security-value" id="securityThreats">0</span>
                            ...
                            <div class="security-stat">
                                <div class="security-icon">🚫</div>
                                <div class="security-content">
                                    <span class="security-value" id="blockedIPs">12</span>
                                    <span class="security-label">Blocked IPs</span>
                                </div>
                            </div>
                            <div class="security-stat">
                                <div class="security-icon">🔑</div>
                                <div class="security-content">
                                    <span class="security-value" id="activeSessions">8</span>
                        ...
                        <div id="tab-sessions" class="security-tab-content active">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                                <h4>Active User Sessions</h4>
                                <button class="btn btn-sm btn-danger" onclick="killAllSessions()">🔴 Kill All Sessions</button>
                            </div>
                        ...
                        <div id="tab-failed-logins" class="security-tab-content">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                                <h4>Failed Login Attempts (Last 24 Hours)</h4>
                                <button class="btn btn-sm" onclick="exportFailedLogins()">📥 Export</button>
                            </div>
                            <div id="failedLoginsList" class="failed-logins-list">
                                <p style="color: #666;">Loading failed logins...</p>
                            </div>
                        </div>
                        ...
                        <div id="tab-ip-management" class="security-tab-content">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                                ...
                                <button class="btn btn-sm btn-primary" onclick="addIPRule()">➕ Add IP Rule</button>
                            </div>
                            <div class="ip-management-grid">
                                <div class="ip-list-container">
                                    <h5>⚫ Blacklist</h5>
                                    <div id="blacklistIPs" class="ip-list">
                                        <p style="color: #666;">No blocked IPs</p>
                                    </div>
                                </div>
                                <div class="ip-list-container">
                                    <h5>⚪ Whitelist</h5>
                                    <div id="whitelistIPs" class="ip-list">
                        ...
                        <div id="tab-2fa" class="security-tab-content">
                            ...
                            <div class="settings-grid" style="margin-top: 20px;">
                                <div class="setting-item">
                                    ...
                                    <small>Require two-factor authentication for all accounts</small>
                                </div>
                                <div class="setting-item">
                                    <label for="enforce2FAAdmin">
                                        <input type="checkbox" id="enforce2FAAdmin" checked>
                                        Enforce 2FA for Admins
                                    </label>
                                    <small>Administrators must use 2FA</small>
                                </div>
                                <div class="setting-item">
                                    ...
                                    <small>Default 2FA method for users</small>
                                </div>
                                <div class="setting-item">
                                    <label for="2faGracePeriod">Grace Period (days)</label>
                                    <input type="number" id="2faGracePeriod" value="7" min="0" max="30">
                                    <small>Days before 2FA is mandatory after enabling</small>
                                </div>
                            </div>
                            <div style="margin-top: 20px;">
                                <h5>User 2FA Status</h5>
                                <div id="user2FAStatus" class="user-2fa-status">
                                    <p style="color: #666;">Loading...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="tab-audit-log" class="security-tab-content">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                                <h4>Security Audit Log</h4>
                                <div>
                                    <select id="auditLogFilter" onchange="loadSecurityAudit()">
                                        <option value="all">All Events</option>
                                        <option value="login">Login Events</option>
                                        <option value="permission">Permission Changes</option>
                                        <option value="config">Config Changes</option>
                                    ...
                                    <button class="btn btn-sm" onclick="exportAuditLog()">📥 Export</button>
                                </div>
                            </div>
                            <div id="securityAuditLog" class="security-audit-log">
                                <p style="color: #666;">Loading audit log...</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="admin-section">
                            ...
                            <div class="storage-visual">
                                <div class="storage-chart">
                                    <svg width="200" height="200" viewBox="0 0 200 200">
                                        ...
                                        <circle id="storageCircle" cx="100" cy="100" r="80" fill="none" stroke="#667eea" stroke-width="20" 
                                                stroke-dasharray="502.65" stroke-dashoffset="125.66" transform="rotate(-90 100 100)"/>
                                        <text x="100" y="95" text-anchor="middle" font-size="24" font-weight="600" fill="#333" id="storagePercent">75%</text>
                                        <text x="100" y="115" text-anchor="middle" font-size="12" fill="#666">Used</text>
                                    </svg>
                                </div>
                                <div class="storage-details">
                                    <div class="storage-stat">
                                        ...
                                        <span class="value" id="totalSpace">100 GB</span>
                                    </div>
                                    <div class="storage-stat">
                                        <span class="label">Used:</span>
                                        <span class="value" id="usedSpace">75 GB</span>
                                    </div>
                                    <div class="storage-stat">
                                        <span class="label">Available:</span>
                                        <span class="value" id="availableSpace">25 GB</span>
                                    </div>
                                    <div class="storage-stat">
                                        <span class="label">Files:</span>
                                        <span class="value" id="totalFiles">15,432</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Storage Actions -->
                        <div class="storage-actions">
                            <button class="btn btn-primary" onclick="analyzeStorage()">🔍 Analyze Storage</button>
                            <button class="btn" onclick="findLargeFiles()">📊 Find Large Files</button>
                            <button class="btn" onclick="findDuplicates()">🔄 Find Duplicates</button>
                            <button class="btn" onclick="cleanupOrphaned()">🧹 Cleanup Orphaned Files</button>
                            <button class="btn btn-danger" onclick="compressImages()">📦 Batch Compress</button>
                        </div>

                        <!-- Storage Breakdown -->
                        <div class="storage-breakdown">
                            <h4>Storage Breakdown by User</h4>
                            <div id="storageByUser" class="storage-user-list">
                                <p style="color: #666;">Loading...</p>
                            </div>
                        </div>
                        ...
                        <div class="storage-breakdown">
                            ...
                            <canvas id="storageByTypeChart" style="max-height: 300px;"></canvas>
                        </div>

                        <!-- Large Files -->
                        <div id="largeFilesSection" class="storage-section" style="display: none;">
                            <h4>🔍 Large Files (> 5 MB)</h4>
                            <div id="largeFilesList" class="large-files-list">
                                <p style="color: #666;">Run analysis to find large files</p>
                            </div>
                        </div>

                        <!-- Duplicate Files -->
                        <div id="duplicatesSection" class="storage-section" style="display: none;">
                            <h4>🔄 Duplicate Files</h4>
                            <div id="duplicatesList" class="duplicates-list">
                                <p style="color: #666;">Run analysis to find duplicates</p>
                            </div>
                        </div>

                        <!-- Orphaned Files -->
                        <div id="orphanedSection" class="storage-section" style="display: none;">
                            <h4>🧹 Orphaned Files (No DB Record)</h4>
                            <div id="orphanedFilesList" class="orphaned-files-list">
                                <p style="color: #666;">Run analysis to find orphaned files</p>
                            </div>
                        </div>
                    </div>
                </div>
